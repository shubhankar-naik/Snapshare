...
const Profile  = ()=>{
    ...
    useEffect(()=>{
       if(image){
        ...
        fetch("https://api.cloudinary.com/v1_1/snapshare/image/upload",{
            method:"post",
            body:data
        })
        .then(res=>res.json())
       ...
       <div style={{maxWidth:"550px",margin:"0px auto"}}>
           ...
           <div style={{
               ...
               <div>
                   ...
                   <h5 style={{fontWeight:"400",fontSize:"20px"}}>{state?state.email:"loading"}</h5>
                   <div style={{display:"flex",justifyContent:"space-between",width:"104%"}}>
                       ...
                       <h6 style={{fontWeight:"300"}}>{state?state.following.length:"0"} following</h6>
                   </div>
